    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="inline-block p-12 rounded-2xl border border-gold-600/20 bg-slate-900/50">
          ...
          <h1 className="text-3xl font-bold text-white mb-4">League Coverage Coming Soon</h1>
          <p className="text-gray-400 max-w-md mb-8">
            This page will feature detailed league statistics, team analysis, and comprehensive match histories. Continue building this section by prompting for more details!
          </p>
          <Link
            to="/predictions"
